...
<qgis version="2.1.0-Beta" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="&quot;highway&quot; is not null" label="caminos">
        <rule filter="&quot;highway&quot; = 'motorway' " label="carreteras">
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 0" symbol="0" label="carretera"/>
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 1" symbol="1" label="tunel"/>
        </rule>
        <rule filter="&quot;highway&quot; IN ( 'motorway_link','trunk','primary')" label="av. principales">
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 0" symbol="2" label="av. principales"/>
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 1" symbol="3" label="tunel"/>
        </rule>
        <rule filter="&quot;highway&quot; IN ( 'trunk_link','primary_link','secondary','secondary_link','road','tertiary','tertiary_link')" symbol="4" label="autopistas"/>
        <rule scalemaxdenom="1000" filter="&quot;highway&quot; is not null" symbol="5" scalemindenom="1" label="calles"/>
        <rule scalemaxdenom="125000" filter="&quot;highway&quot; is not null" symbol="6" scalemindenom="12000" label="calles"/>
        <rule scalemaxdenom="12000" filter=" &quot;highway&quot;  IN ( 'tertiary')" symbol="7" label="Terciario"/>
        <rule scalemaxdenom="12000" filter=" &quot;highway&quot;  IN ('residential')" symbol="8" label="calles residenciales"/>
        <rule scalemaxdenom="50000" filter=" &quot;highway&quot;  IN ('service', 'road', 'unclassified', 'track')" symbol="9" scalemindenom="1000" label="Small Road"/>
        <rule scalemaxdenom="50000" filter="&quot;highway&quot; IN ('footway', 'path')" symbol="10" scalemindenom="1000" label="caminos peatonales"/>
        <rule filter="&quot;highway&quot; IN ('footway', 'path') and &quot;bridge&quot; = 'yes'" symbol="11" label="puentes peatonales"/>
        <rule scalemaxdenom="200000" filter=" &quot;aeroway&quot; = 'taxiway'" symbol="12" label="sitio de taxi en el aeropuerto"/>
        <rule scalemaxdenom="200000" filter=" &quot;aeroway&quot; = 'runway'" symbol="13" label="pista de aeropuerto"/>
        <rule scalemaxdenom="350000" filter=" &quot;aeroway&quot; = 'runway'" symbol="14" scalemindenom="200000" label="pista de aeropuerto acercamiento"/>
      </rule>
      <rule filter="&quot;other_tags&quot; LIKE '%&quot;rail&quot;%' or &quot;other_tags&quot; LIKE '%&quot;railway&quot;%'" symbol="15" label="vias de tren">
        <rule scalemaxdenom="150000" filter=" &quot;railway&quot;  = 'rail' and &quot;bridge&quot; = 'yes'" symbol="16" label="puentes de vias de tren"/>
        <rule scalemaxdenom="150000" filter=" &quot;railway&quot;  = 'rail'" symbol="17" label="vias de tren"/>
      </rule>
      <rule filter="&quot;waterway&quot; = 'river'" label="rios">
        <rule scalemaxdenom="125000" symbol="18" label="rio"/>
        <rule symbol="19" scalemindenom="125000" label="rio"/>
      </rule>
      <rule filter="other_tags LIKE '%border%' OR other_tags LIKE '%boundary%'" label="limites">
        <rule filter="other_tags LIKE '%&quot;admin_level&quot;=>&quot;2&quot;%'" symbol="20" label="admin lvl 2"/>
        <rule filter="other_tags LIKE '%&quot;admin_level&quot;=>&quot;4&quot;%' " symbol="21" label="admin lvl 4"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.486275" type="line" name="10">
