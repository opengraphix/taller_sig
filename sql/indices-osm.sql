...
CREATE INDEX idx_planet_osm_polygon_tags ON planet_osm_polygon USING gist(way_area);
...
CREATE INDEX "idx_poly_aeroway1" on planet_osm_polygon  USING gist (way) WHERE "aeroway" IS NOT NULL ;
